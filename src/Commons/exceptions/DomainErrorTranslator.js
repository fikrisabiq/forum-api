...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.NOT_LOGIN': new AuthenticationError('harus login terlebih dahulu'),
  ...
  'ADD_COMMENT.NOT_LOGIN': new AuthenticationError('harus login terlebih dahulu'),
  ...
  'ADD_REPLY.NOT_LOGIN': new AuthenticationError('harus login terlebih dahulu'),
